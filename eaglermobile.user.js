...
// Only inject Pocket Edition-style overlay and canvas touch handling when page sets window.eaglerMobileTouch === true (e.g. in index.html).
waitForElm('canvas').then(() => { if (window.eaglerMobileTouch === true) insertCanvasElements(); });
